...
public class YufukuanInView extends YufukuanInEntity implements Serializable {
	...
	public YufukuanInView() {

	}

	public YufukuanInView(YufukuanInEntity yufukuanInEntity) {
		try {
			BeanUtils.copyProperties(this, yufukuanInEntity);
