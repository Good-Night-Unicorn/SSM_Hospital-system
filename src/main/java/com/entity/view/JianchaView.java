 ...
 */
@TableName("jiancha")
public class JianchaView extends JianchaEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		/**
		* 检查类型的值
		*/
		private String jianchaValue;
	...
	public JianchaView(JianchaEntity jianchaEntity) {
		try {
			BeanUtils.copyProperties(this, jianchaEntity);
			...
			* 获取： 检查类型的值
			*/
			public String getJianchaValue() {
				return jianchaValue;
			}
			/**
			* 设置： 检查类型的值
			*/
			public void setJianchaValue(String jianchaValue) {
				this.jianchaValue = jianchaValue;
			}
