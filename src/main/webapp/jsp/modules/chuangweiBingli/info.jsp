            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">患者住院房屋登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="room" name="room" class="form-control"
                                                   v-model="ruleForm.room" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="chuangweiYesnoValue" name="chuangweiYesnoValue" class="form-control"
                                               v-model="ruleForm.chuangweiYesnoValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="chuangweiId" name="chuangweiId" v-model="ruleForm.chuangweiId" readonly type="hidden">
                                ...
                                <div class="form-group col-md-6">
                                    <label>是否在住</label>
                                    <input id="chuangweiBingliYesnoValue" name="chuangweiBingliYesnoValue" class="form-control"
                                           v-model="ruleForm.chuangweiBingliYesnoValue" readonly>
                                </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "chuangweiBingli/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.chuangweiBingliContent != null && ruleForm.chuangweiBingliContent != 'null' && ruleForm.chuangweiBingliContent != '') {
            var chuangweiBingliContentUeditor = UE.getEditor('chuangweiBingliContentEditor');
                chuangweiBingliContentUeditor.ready(function () {
                    var mes = '' + ruleForm.chuangweiBingliContent;
                    chuangweiBingliContentUeditor.setContent(mes);
                    chuangweiBingliContentUeditor.setDisabled('fullscreen');
            });
        }
    }
