            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">检查登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="bingliId" name="bingliId" v-model="ruleForm.bingliId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jianchaName" name="jianchaName" class="form-control"
                                               v-model="ruleForm.jianchaName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>检查类型</label>
                                    <input id="jianchaValue" name="jianchaValue" class="form-control"
                                           v-model="ruleForm.jianchaValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.jianchaContent != null && ruleForm.jianchaContent != 'null' && ruleForm.jianchaContent != '') {
            var jianchaContentUeditor = UE.getEditor('jianchaContentEditor');
                jianchaContentUeditor.ready(function () {
                    var mes = '' + ruleForm.jianchaContent;
                    jianchaContentUeditor.setContent(mes);
                    jianchaContentUeditor.setDisabled('fullscreen');
            });
        }
    }
