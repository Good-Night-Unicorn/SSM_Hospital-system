    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑预付款缴费</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">预付款缴费管理</li>
                        <li class="breadcrumb-item active">编辑预付款缴费</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">预付款缴费信息</h3>
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yufukuanId" name="yufukuanId" type="hidden">
                                    <div class="form-group col-md-6">
                                        <label>缴费金额</label>
                                        <input id="yufukuanInMoney" name="yufukuanInMoney" class="form-control"
                                               onchange="yufukuanInMoneyChickValue(this)" placeholder="缴费金额">
                                    </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("yufukuanIn/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addyufukuanIn');
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function yufukuanInMoneyChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                yufukuanId: "required",
                yufukuanInMoney: "required",
                insertTime: "required",
            },
            messages: {
                yufukuanId: "预付款账户不能为空",
                yufukuanInMoney: "缴费金额不能为空",
                insertTime: "缴费时间不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addyufukuanIn = window.sessionStorage.getItem("addyufukuanIn");
        if (addyufukuanIn != null && addyufukuanIn != "" && addyufukuanIn != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("yufukuanIn/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#yufukuanInMoney").val(ruleForm.yufukuanInMoney);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            // 缴费金额设置不可选
            // $('#yufukuanInMoney').attr('readonly', 'readonly');
        }
