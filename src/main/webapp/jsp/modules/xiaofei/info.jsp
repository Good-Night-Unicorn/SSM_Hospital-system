            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">消费登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>患者</label>
                                            <input id="bingliId" name="bingliId" class="form-control"
                                                   v-model="ruleForm.bingliId" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="yufukuanDanhaoNumber" name="yufukuanDanhaoNumber" class="form-control"
                                                   v-model="ruleForm.yufukuanDanhaoNumber" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="yufukuanMoney" name="yufukuanMoney" class="form-control"
                                                   v-model="ruleForm.yufukuanMoney" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yufukuanId" name="yufukuanId" v-model="ruleForm.yufukuanId" readonly type="hidden">

                                    <div class="form-group col-md-6">
                                        <label>消费名目</label>
                                        <input id="xiaofeiName" name="xiaofeiName" class="form-control"
                                               v-model="ruleForm.xiaofeiName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>消费类型</label>
                                    <input id="xiaofeiValue" name="xiaofeiValue" class="form-control"
                                           v-model="ruleForm.xiaofeiValue" readonly>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xiaofeiMoney" name="xiaofeiMoney" class="form-control"
                                               v-model="ruleForm.xiaofeiMoney" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.xiaofeiContent != null && ruleForm.xiaofeiContent != 'null' && ruleForm.xiaofeiContent != '') {
            var xiaofeiContentUeditor = UE.getEditor('xiaofeiContentEditor');
                xiaofeiContentUeditor.ready(function () {
                    var mes = '' + ruleForm.xiaofeiContent;
                    xiaofeiContentUeditor.setContent(mes);
                    xiaofeiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
