            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">医嘱登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="huanzheDanhaoNumber" name="huanzheDanhaoNumber" class="form-control"
                                                   v-model="ruleForm.huanzheDanhaoNumber" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="keshiValue" name="keshiValue" class="form-control"
                                               v-model="ruleForm.keshiValue" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="bingliYesnoValue" name="bingliYesnoValue" class="form-control"
                                               v-model="ruleForm.bingliYesnoValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="bingliId" name="bingliId" v-model="ruleForm.bingliId" readonly type="hidden">

                                    <div class="form-group col-md-6">
                                        <label>医嘱名字</label>
                                        <input id="yizhuName" name="yizhuName" class="form-control"
                                               v-model="ruleForm.yizhuName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>医嘱类型</label>
                                    <input id="yizhuValue" name="yizhuValue" class="form-control"
                                           v-model="ruleForm.yizhuValue" readonly>
                                </div>


                                <div>
                                    <label>医嘱详情</label>
                                    <script id="yizhuContentEditor" type="text/plain"
                                            style="width:800px;height:230px;"></script>
                                    <script type = "text/javascript" >
                                    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
                                    //相见文档配置属于你自己的编译器
                                    var yizhuContentUe = UE.getEditor('yizhuContentEditor', {
                                        toolbars: [
                                            [
                                                'undo', //撤销
                                                'bold', //加粗
                                    ...
                                    <input type="hidden" name="yizhuContent" id="yizhuContent-input">
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.zhusuContent != null && ruleForm.zhusuContent != 'null' && ruleForm.zhusuContent != '') {
            var zhusuContentUeditor = UE.getEditor('zhusuContentEditor');
                zhusuContentUeditor.ready(function () {
                    ...
                    zhusuContentUeditor.setDisabled('fullscreen');
            });
        }
        if (ruleForm.zhenduanContent != null && ruleForm.zhenduanContent != 'null' && ruleForm.zhenduanContent != '') {
            var zhenduanContentUeditor = UE.getEditor('zhenduanContentEditor');
                zhenduanContentUeditor.ready(function () {
                    ...
                    zhenduanContentUeditor.setDisabled('fullscreen');
            });
        }
        if (ruleForm.yizhuContent != null && ruleForm.yizhuContent != 'null' && ruleForm.yizhuContent != '') {
            var yizhuContentUeditor = UE.getEditor('yizhuContentEditor');
                yizhuContentUeditor.ready(function () {
                    var mes = '' + ruleForm.yizhuContent;
                    yizhuContentUeditor.setContent(mes);
                    yizhuContentUeditor.setDisabled('fullscreen');
            });
        }
    }
