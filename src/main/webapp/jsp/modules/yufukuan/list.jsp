...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">预付款账户管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">预付款账户列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">预付款账户列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //是否到阈值(50元)
            var yufukuanMoneyCell = document.createElement('td');
            if(item.yufukuanMoney <=50){
                yufukuanMoneyCell.innerHTML = "请提醒充值";
            }else{
                yufukuanMoneyCell.innerHTML = "";
            }
            row.appendChild(yufukuanMoneyCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("yufukuan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addyufukuan", "addyufukuan");
            window.location.href = "add-or-update.jsp"
        }
